...
public class moduloClientesBloqueados extends javax.swing.JInternalFrame {

    public moduloClientesBloqueados() {
        initComponents();
        listarClientes();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Fecha Instalacion", "Ip", "Dia de Corte", "Antens AP", "Servicios", "MikroTik"
            }
        ));
    ...
    private void click_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_click_eliminarActionPerformed
        ...
        try {
            ...
            if (filaSeleccionada >= 0) {
                ...
                String target = (String)jTable1.getValueAt(filaSeleccionada, 3);
                String mikoritik = (String)jTable1.getValueAt(filaSeleccionada, 7);
                listarClientes();
        ...
        if (cn != null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    clientes[2] = rs.getString("fecha_registro");
                    clientes[3] = rs.getString("ip_cliente");
                    clientes[4] = rs.getString("dia_corte");
                    clientes[5] = rs.getString("antena_ap");
                    clientes[6] = rs.getString("servicio_plataforma");
                    clientes[7] = rs.getString("microtik_nombre");
    ...
    public void bloquearCliente() {
        ...
        if (filaSeleccionada >= 0) {
            int id = (int) jTable1.getValueAt(filaSeleccionada, 0);
            String nombreMicrotik = (String) jTable1.getValueAt(filaSeleccionada, 7);
            String targetIp = (String) jTable1.getValueAt(filaSeleccionada, 3);
...
//                        auto.bloquearClientePPoE(id, targetIp, user, routerIp, password);
    ...
    public void testConexion() {
        ...
        if (filaSeleccionada >= 0) {
            ...
            try {
                String nombreMicrotik = (String) jTable1.getValueAt(filaSeleccionada, 7);
                String direccion_ip = (String) jTable1.getValueAt(filaSeleccionada, 3);
                cursor = cn.prepareStatement(sql);
                cursor.setString(1, nombreMicrotik);
