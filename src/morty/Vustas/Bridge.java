 ...
 * @author ricardo
 */
public class Bridge extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Name Bridge"));

        jLabel4.setText("Name");

        btnAPlicar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/caja.png"))); // NOI18N
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Bridge List"));
    ...
    private void btnAPlicarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAPlicarActionPerformed
        ...
        String bridge = entryName.getText();
        ...
        if (host.isBlank() && user.isBlank() && password.isBlank()) {
            ...
            bridge = bridge.trim();
            bridge = bridge.replaceAll("[^a-zA-Z0-9]", "");

            auto.createBridge(host, user, password, bridge);

            bridgeList(user, password, host);
        }
        // TODO add your handling code here:
