 ...
 * @author ricardo
 */
public class AddInterfaceBridge extends javax.swing.JInternalFrame {

    /**
     * Creates new form AddInterfaceBridge
     */
    ...
    private void initComponents() {
        ...
        entryBridge = new javax.swing.JTextField();
        jButton1 = new javax.swing.JButton();
        jPanel6 = new javax.swing.JPanel();
        jScrollPane4 = new javax.swing.JScrollPane();
        tablaPort = new javax.swing.JTable();
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Add Interface to Bridge");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Interface to Bridge"));
        ...
        jLabel6.setText("Bridge");

        entryBridge.setEditable(false);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(entryInterface, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel5)
                        .addGap(18, 18, 18)
                        .addComponent(jLabel6)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(entryBridge, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel6)
                        .addComponent(entryBridge, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder("Bridge Ports"));

        tablaPort.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        jScrollPane4.setViewportView(tablaPort);
    ...
    private void tablaBridgeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaBridgeMouseClicked
        ...
        if (rows >= 0) {
            ...
            entryBridge.setText(bridgeName);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String interfaceName = entryInterface.getText();
        String bridge = entryBridge.getText();
        String host = entryHost.getText();
        String user = entryUsername.getText();
        String password = entryPassword.getText();

        if (interfaceName.isBlank() && bridge.isBlank()) {
            JOptionPane.showMessageDialog(null, "Los campos de interfaz y bridge no pueden estar vacios");
        } else {
            PPoEAuto auto = new PPoEAuto();
            auto.interfazABridge(interfaceName, bridge, user, password, host);
            bridgePorts(user, password, host);
        }
        // TODO add your handling code here:
            ...
            if (cn != null) {
                ...
                try {
                    ...
                    if (resultado.next()) {
                        ...
                        bridgeList(username, password, ip);
    ...
    private javax.swing.JTextField entryBridge;
    ...
    private javax.swing.JTable tablaPort;
    ...
    public void bridgeList(String username, String password, String ip) {
        try {
    ...
    public void bridgePorts(String username, String password, String ip) {
        try {
            ...
            // Ejecutar el comando para obtener las leases DHCP bloqueadas
            List<Map<String, String>> results = con.execute("/interface/bridge/port/print");

            // Inicializar el modelo de la tabla
            DefaultTableModel modelo = (DefaultTableModel) tablaPort.getModel();
            ...
            for (Map<String, String> result : results) {
                ...
                // Asignar los valores a cada columna
                clientesDhcpLeases[0] = result.get("interface");
                clientesDhcpLeases[1] = result.get("bridge");
