        ...
        if (resultado.next()) {
            ...
            if (password.equals(passwordBD)) {
                switch (rol) {
                    ...
                    case 1: // Cajero
                        dispose();
                        CAJEROUI cajeroui = new CAJEROUI(username);
                        cajeroui.setVisible(true);
                        // Aquí podrías abrir otra interfaz especial para cajeros si quieres
                        break;
                    case 2: // Cliente
                        JOptionPane.showMessageDialog(null, "¡Bienvenido cliente " + username + "!");
                        // Aquí podrías abrir un panel limitado o mostrar info personal
                        break;
                    default:
